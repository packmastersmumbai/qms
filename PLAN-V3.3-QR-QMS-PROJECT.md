...
| 7 DWM-mirrored operators briefed (30 min each) — Khushi/1111 (GRN), Rajesh/4444 (Gate+Security), Anuj/2222 (Floor-1), Santosh/3333 (Floor-2), Admin/1234 + TBM/5555 (admin fallback), BBM/6666 (owner observer). Brief = [PLAN-V3.3-OPERATOR-BRIEF.md](PLAN-V3.3-OPERATOR-BRIEF.md). | Dev | Each does 3 successful scans |
| [PLAN-V3.3-VALIDATION-PROTOCOL.md](PLAN-V3.3-VALIDATION-PROTOCOL.md) signed | QMS owner + warehouse-in-charge | Initialled hardcopy filed |
